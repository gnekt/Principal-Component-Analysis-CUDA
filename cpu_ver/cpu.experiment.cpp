...
int main(int argc, char* argv[]) {
    ...
    for (int experiment = 0; experiment < 11; experiment++) {
        ...
        for (int stepIdx = 0; stepIdx < 4; stepIdx++) {
            ...
            for (int iterationTimeIdx = 0; iterationTimeIdx < experimentNumberOfIterationCpu[experiment]; iterationTimeIdx++) {
                ...
                elapsedTimeStd += ((interTimeIterations[iterationTimeIdx][stepIdx] - elapsedTimeMean) *
                                   (interTimeIterations[iterationTimeIdx][stepIdx] - elapsedTimeMean)) / experimentNumberOfIterationCpu[experiment];
            }
        ...
        // Write eigenvectors for this experiment
        string temp = outputExperimentFileName + "." + to_string(experiment + 1) + ".csv";
    ...
    string temp = outputExperimentFileName + ".measurement.csv";
    outputFile_handler.open(temp.c_str());
    for (int experiment = 0; experiment < 11; experiment++) {
