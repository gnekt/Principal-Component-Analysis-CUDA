/*
    Program that generate all the experiment needed for the gpu1 program of PCA
*/
...
/*
    ...
    How to use it:
    ./experiment <string> name of output csv (Eg. kronos.gpu1 )
*/
...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        cerr << "error: insufficient input.\n"
                "usage: " << argv[0] << " <string> name of output csv (Eg. kronos.gpu1 ) \n";
        return 1;
    }
